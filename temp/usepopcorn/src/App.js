...
function MovieDetails({
  ...
  const previouslyWatched = watched.find(
          ...
          <section>
            <div className="rating">
              <StarRating
                ...
                defaultRating={
                  previouslyWatched ? previouslyWatched.userRating : 0
                }
              />
              {userRating > 0 && !previouslyWatched && (
                <button className="btn-add" onClick={handleAdd}>
                  + Add to list
                </button>
              )}
              {previouslyWatched &&
                previouslyWatched.userRating !== userRating && (
